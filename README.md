...
Dit systeem gebruikt een multi-agent architectuur gebouwd met Rivet om:
...
### Vereisten
- [Rivet](https://rivet.ironcladapp.com/) (download van officiele website)
- OpenAI API key of Azure OpenAI endpoint

### Setup
1. Open Rivet
2. Importeer `consultant-recommender.rivet-project`
3. Configureer je LLM settings (OpenAI API key)
4. Test de workflow met voorbeelddata
...
- Parallel execution: Service, Best Practices en Knowledge agents draaien parallel
- Token efficiency: ~8000-15000 tokens per complete run
